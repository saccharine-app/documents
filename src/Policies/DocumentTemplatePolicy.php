...
class DocumentTemplatePolicy
{
    ...
    {
        return $user->can('view_any_document::template');
    }
    ...
    {
        return $user->can('view_document::template');
    }
    ...
    {
        return $user->can('create_document::template');
    }
    ...
    {
        return $user->can('update_document::template');
    }
    ...
    {
        return $user->can('delete_document::template');
    }
    ...
    {
        return $user->can('delete_any_document::template');
    }
    ...
    {
        return $user->can('force_delete_document::template');
    }
    ...
    {
        return $user->can('force_delete_any_document::template');
    }
    ...
    {
        return $user->can('restore_document::template');
    }
    ...
    {
        return $user->can('restore_any_document::template');
    }
    ...
    {
        return $user->can('replicate_document::template');
    }
    ...
    {
        return $user->can('reorder_document::template');
    }
}
